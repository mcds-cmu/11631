...
The title of the review should be `A review of \citet{yourPaper}` and the `\author` should be your first and last name. Name the file `review.pdf`.
...
6. **Format and Submission:**
   ...
   - The title of the review should be `A review of [topic]` and the `\author` should be the first and last names of each teammate. Name the file `draft-literature-survey.pdf`.
...
- *2 points* - Formatting & turning in assignment: 
  - Did the student turn in the assignment on time? Is it using Latex & fits within the page limit? Is the paper using proper citations format, grammatical text, etc.?
